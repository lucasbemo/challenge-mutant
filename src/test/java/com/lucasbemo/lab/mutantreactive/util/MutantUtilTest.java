package com.lucasbemo.lab.mutantreactive.util;
...
public class MutantUtilTest {
    ...
    public static String[] DNA_MUTANT_OBLIQUE_FROM_LEFT_COLUMN_0_LINE_0 = {
            "ATGCAT",
            "TACGTA",
            "ATACAT",
            "TACATA",
    ...
    public static String[] DNA_WITH_SPECIAL_CHARACTERS = {
            "@#$@#|",
            "^`';.%",
            "_ -S $",
            "]{+=\"",
